...
public class HTTPParser extends Parser {
	...
	public static final int
		OPEN_BLOCK_BRAKET=1, CLOSE_BLOCK_BRAKET=2, WS=3, BODY_START_WITH_BLANK=4, 
		GENERIC_BODY_START=5, NEWLINE=6, REQUEST_SEPARATOR=7, COMMENT=8, METHOD=9, 
		HTTP_PROTOCOL=10, COLON=11, DOT=12, COMMA=13, SLASH=14, QUESTION_MARK=15, 
		HASH=16, ASTERISK=17, EQUAL=18, AMPERSAND=19, PERCENT=20, OPEN_BRAKET=21, 
		CLOSE_BRAKET=22, QUOTE=23, DIGITS=24, SCHEME=25, ALPHA_CHARS=26, DASH=27, 
		UNDERSCORE=28, SCHEME_SEPARATOR=29, INPUT_FILE_REF=30, RESPONSE_HANDLER_SCRIPT_START=31, 
		RESPONSE_HANDLER_SCRIPT_END=32, RESPONSE_HANDLER_FILE_REF=33, SCRIPT_CONTENT=34, 
		ENV_VARIABLE=35, MULTIPART_BOUNDARY=36, MULTIPART_PART=37, BODY_START_NO_BLANK=38, 
		ERROR=39, STRING=40, NUMBER=41, TRUE=42, FALSE=43, NULL=44, BODY_TEXT=45, 
		JSON_RBRACE=46;
	public static final int
		RULE_httpRequestsFile = 0, RULE_requestBlock = 1, RULE_request = 2, RULE_requestHeaders = 3, 
		RULE_headerLine = 4, RULE_invalidBodyWithoutRequest = 5, RULE_invalidHeaderLine = 6, 
		RULE_invalidHeaderContent = 7, RULE_requestBodySection = 8, RULE_requestBody = 9, 
		RULE_bodyWithStarter = 10, RULE_bodyContent = 11, RULE_directBodyContent = 12, 
		RULE_jsonObject = 13, RULE_pair = 14, RULE_jsonArray = 15, RULE_jsonValue = 16, 
		RULE_jsonString = 17, RULE_jsonStringContent = 18, RULE_jsonStringChar = 19, 
		RULE_jsonNumber = 20, RULE_jsonBareWord = 21, RULE_space = 22, RULE_header = 23, 
		RULE_headerField = 24, RULE_headerFieldName = 25, RULE_headerFieldValue = 26, 
		RULE_fieldName = 27, RULE_fieldValue = 28, RULE_blank = 29, RULE_requestLine = 30, 
		RULE_requestLineWithBody = 31, RULE_requestTarget = 32, RULE_originForm = 33, 
		RULE_absolutePath = 34, RULE_segment = 35, RULE_pathSeparator = 36, RULE_absoluteForm = 37, 
		RULE_hostPort = 38, RULE_host = 39, RULE_ipAddress = 40, RULE_ipv4Address = 41, 
		RULE_ipv6Address = 42, RULE_ipv6Literal = 43, RULE_fullIPv6 = 44, RULE_compressedIPv6 = 45, 
		RULE_hextet = 46, RULE_hexa = 47, RULE_slashPathPart = 48, RULE_pathSegment = 49, 
		RULE_asteriskForm = 50, RULE_queryPart = 51, RULE_queryContent = 52, RULE_queryParam = 53, 
		RULE_queryKey = 54, RULE_queryValue = 55, RULE_fragmentPart = 56, RULE_fragmentContent = 57, 
		RULE_httpVersion = 58, RULE_versionNumber = 59, RULE_invalidContent = 60;
	private static String[] makeRuleNames() {
		return new String[] {
			"httpRequestsFile", "requestBlock", "request", "requestHeaders", "headerLine", 
			"invalidBodyWithoutRequest", "invalidHeaderLine", "invalidHeaderContent", 
			"requestBodySection", "requestBody", "bodyWithStarter", "bodyContent", 
			"directBodyContent", "jsonObject", "pair", "jsonArray", "jsonValue", 
			"jsonString", "jsonStringContent", "jsonStringChar", "jsonNumber", "jsonBareWord", 
			"space", "header", "headerField", "headerFieldName", "headerFieldValue", 
			"fieldName", "fieldValue", "blank", "requestLine", "requestLineWithBody", 
			"requestTarget", "originForm", "absolutePath", "segment", "pathSeparator", 
			"absoluteForm", "hostPort", "host", "ipAddress", "ipv4Address", "ipv6Address", 
			"ipv6Literal", "fullIPv6", "compressedIPv6", "hextet", "hexa", "slashPathPart", 
			"pathSegment", "asteriskForm", "queryPart", "queryContent", "queryParam", 
			"queryKey", "queryValue", "fragmentPart", "fragmentContent", "httpVersion", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, null, null, null, null, null, null, null, null, null, "'HTTP'", 
			null, "'.'", null, "'/'", "'?'", "'#'", "'*'", "'='", "'&'", "'%'", null, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "OPEN_BLOCK_BRAKET", "CLOSE_BLOCK_BRAKET", "WS", "BODY_START_WITH_BLANK", 
			"GENERIC_BODY_START", "NEWLINE", "REQUEST_SEPARATOR", "COMMENT", "METHOD", 
			"HTTP_PROTOCOL", "COLON", "DOT", "COMMA", "SLASH", "QUESTION_MARK", "HASH", 
			"ASTERISK", "EQUAL", "AMPERSAND", "PERCENT", "OPEN_BRAKET", "CLOSE_BRAKET", 
			"QUOTE", "DIGITS", "SCHEME", "ALPHA_CHARS", "DASH", "UNDERSCORE", "SCHEME_SEPARATOR", 
			"INPUT_FILE_REF", "RESPONSE_HANDLER_SCRIPT_START", "RESPONSE_HANDLER_SCRIPT_END", 
			"RESPONSE_HANDLER_FILE_REF", "SCRIPT_CONTENT", "ENV_VARIABLE", "MULTIPART_BOUNDARY", 
			"MULTIPART_PART", "BODY_START_NO_BLANK", "ERROR", "STRING", "NUMBER", 
			"TRUE", "FALSE", "NULL", "BODY_TEXT", "JSON_RBRACE"
		};
	}
	...
	public final RequestHeadersContext requestHeaders() throws RecognitionException {
		...
		enterRule(_localctx, 6, RULE_requestHeaders);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final HeaderLineContext headerLine() throws RecognitionException {
		...
		enterRule(_localctx, 8, RULE_headerLine);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			...
			case 1:
				...
				case 2:
					{
					setState(197);
					if (!(_input.LA(1) == BODY_START_WITH_BLANK || _input.LA(1) == GENERIC_BODY_START || _input.LA(1) == BODY_START_NO_BLANK || _input.LA(1) == EOF)) throw new FailedPredicateException(this, "_input.LA(1) == BODY_START_WITH_BLANK || _input.LA(1) == GENERIC_BODY_START || _input.LA(1) == BODY_START_NO_BLANK || _input.LA(1) == EOF");
					}
					break;
				}
				}
	...
	public static class InvalidBodyWithoutRequestContext extends ParserRuleContext {
		...
		public TerminalNode GENERIC_BODY_START() { return getToken(HTTPParser.GENERIC_BODY_START, 0); }
	...
	public final InvalidBodyWithoutRequestContext invalidBodyWithoutRequest() throws RecognitionException {
		...
		enterRule(_localctx, 10, RULE_invalidBodyWithoutRequest);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			...
			setState(210);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 274877906992L) != 0)) ) {
			...
			setState(217);
			_la = _input.LA(1);
			if ( !(_la==EOF || _la==REQUEST_SEPARATOR) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final InvalidHeaderLineContext invalidHeaderLine() throws RecognitionException {
		...
		try {
			...
			{
			setState(219);
			if (!(_input.LA(2) != COLON && _input.LA(1) != COMMENT && _input.LA(1) != NEWLINE)) throw new FailedPredicateException(this, "_input.LA(2) != COLON && _input.LA(1) != COMMENT && _input.LA(1) != NEWLINE");
			setState(220);
	...
	public static class InvalidHeaderContentContext extends ParserRuleContext {
		...
		public List<TerminalNode> GENERIC_BODY_START() { return getTokens(HTTPParser.GENERIC_BODY_START); }
		public TerminalNode GENERIC_BODY_START(int i) {
			return getToken(HTTPParser.GENERIC_BODY_START, i);
		}
		public List<TerminalNode> COMMENT() { return getTokens(HTTPParser.COMMENT); }
		public TerminalNode COMMENT(int i) {
			return getToken(HTTPParser.COMMENT, i);
		}
		public List<TerminalNode> EOF() { return getTokens(HTTPParser.EOF); }
		...
		try {
			...
			do {
				...
				case 1:
					...
					setState(225);
					_la = _input.LA(1);
					if ( _la <= 0 || (((((_la - -1)) & ~0x3f) == 0 && ((1L << (_la - -1)) & 549755814897L) != 0)) ) {
					_errHandler.recoverInline(this);
					}
					else {
						if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public static class RequestBodyContext extends ParserRuleContext {
		public BodyWithStarterContext bodyWithStarter() {
			return getRuleContext(BodyWithStarterContext.class,0);
		}
		public DirectBodyContentContext directBodyContent() {
			return getRuleContext(DirectBodyContentContext.class,0);
		}
	...
	@SuppressWarnings("CheckReturnValue")
	public static class BodyWithStarterContext extends ParserRuleContext {
		...
		public TerminalNode BODY_START_NO_BLANK() { return getToken(HTTPParser.BODY_START_NO_BLANK, 0); }
		public TerminalNode GENERIC_BODY_START() { return getToken(HTTPParser.GENERIC_BODY_START, 0); }
		public BodyWithStarterContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_bodyWithStarter; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HTTPParserListener ) ((HTTPParserListener)listener).enterBodyWithStarter(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof HTTPParserListener ) ((HTTPParserListener)listener).exitBodyWithStarter(this);
		}
	}

	public final BodyWithStarterContext bodyWithStarter() throws RecognitionException {
		BodyWithStarterContext _localctx = new BodyWithStarterContext(_ctx, getState());
		enterRule(_localctx, 20, RULE_bodyWithStarter);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class BodyContentContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HTTPParserListener ) ((HTTPParserListener)listener).enterBodyContent(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof HTTPParserListener ) ((HTTPParserListener)listener).exitBodyContent(this);
		}
	}
	...
	public final BodyContentContext bodyContent() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_bodyContent);
		try {
			int _alt;
			setState(258);
			_errHandler.sync(this);
	...
	@SuppressWarnings("CheckReturnValue")
	public static class DirectBodyContentContext extends ParserRuleContext {
		public List<TerminalNode> REQUEST_SEPARATOR() { return getTokens(HTTPParser.REQUEST_SEPARATOR); }
		public TerminalNode REQUEST_SEPARATOR(int i) {
			return getToken(HTTPParser.REQUEST_SEPARATOR, i);
		}
		...
		public DirectBodyContentContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_directBodyContent; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HTTPParserListener ) ((HTTPParserListener)listener).enterDirectBodyContent(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof HTTPParserListener ) ((HTTPParserListener)listener).exitDirectBodyContent(this);
		}
	}

	public final DirectBodyContentContext directBodyContent() throws RecognitionException {
		DirectBodyContentContext _localctx = new DirectBodyContentContext(_ctx, getState());
		enterRule(_localctx, 24, RULE_directBodyContent);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			...
			do {
				...
				case 1:
					...
					setState(260);
					_la = _input.LA(1);
					if ( _la <= 0 || (_la==EOF || _la==REQUEST_SEPARATOR) ) {
					_errHandler.recoverInline(this);
					}
					else {
						if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final JsonObjectContext jsonObject() throws RecognitionException {
		...
		enterRule(_localctx, 26, RULE_jsonObject);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final JsonArrayContext jsonArray() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3298612477954L) != 0)) {
				{
				setState(293);
				jsonValue();
				setState(301);
	...
	public final JsonStringContext jsonString() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_jsonString);
		int _la;
		try {
			setState(324);
			_errHandler.sync(this);
			...
			case QUOTE:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1031796750L) != 0)) {
					{
					setState(320);
					jsonStringContent();
					}
	...
	public final JsonStringContentContext jsonStringContent() throws RecognitionException {
		...
		enterRule(_localctx, 36, RULE_jsonStringContent);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 1031796750L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final JsonStringCharContext jsonStringChar() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_jsonStringChar);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final JsonNumberContext jsonNumber() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_jsonNumber);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(333);
	...
	public final JsonBareWordContext jsonBareWord() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_jsonBareWord);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(335);
	...
	public final HeaderContext header() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_header);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(343);
	...
	public final HeaderFieldContext headerField() throws RecognitionException {
		...
		enterRule(_localctx, 48, RULE_headerField);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final HeaderFieldNameContext headerFieldName() throws RecognitionException {
		...
		enterRule(_localctx, 50, RULE_headerFieldName);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final HeaderFieldValueContext headerFieldValue() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_headerFieldValue);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(360);
					_la = _input.LA(1);
					if ( _la <= 0 || ((((_la) & ~0x3f) == 0 && ((1L << _la) & 274877907056L) != 0)) ) {
					_errHandler.recoverInline(this);
					}
					else {
						if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final FieldValueContext fieldValue() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_fieldValue);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			do {
				...
				setState(373);
				_la = _input.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 486555648L) != 0)) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 486555648L) != 0) );
			setState(379);
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==QUOTE) {
	...
	public final BlankContext blank() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_blank);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final RequestLineContext requestLine() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_requestLine);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final RequestLineWithBodyContext requestLineWithBody() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_requestLineWithBody);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final RequestTargetContext requestTarget() throws RecognitionException {
		...
		enterRule(_localctx, 64, RULE_requestTarget);
		try {
			setState(432);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final OriginFormContext originForm() throws RecognitionException {
		...
		enterRule(_localctx, 66, RULE_originForm);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final AbsolutePathContext absolutePath() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_absolutePath);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final SegmentContext segment() throws RecognitionException {
		...
		enterRule(_localctx, 70, RULE_segment);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final PathSeparatorContext pathSeparator() throws RecognitionException {
		...
		enterRule(_localctx, 72, RULE_pathSeparator);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final AbsoluteFormContext absoluteForm() throws RecognitionException {
		...
		enterRule(_localctx, 74, RULE_absoluteForm);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final IpAddressContext ipAddress() throws RecognitionException {
		...
		enterRule(_localctx, 80, RULE_ipAddress);
		try {
			setState(495);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Ipv4AddressContext ipv4Address() throws RecognitionException {
		...
		enterRule(_localctx, 82, RULE_ipv4Address);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Ipv6AddressContext ipv6Address() throws RecognitionException {
		...
		enterRule(_localctx, 84, RULE_ipv6Address);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Ipv6LiteralContext ipv6Literal() throws RecognitionException {
		...
		enterRule(_localctx, 86, RULE_ipv6Literal);
		try {
			setState(523);
			_errHandler.sync(this);
	...
	public final FullIPv6Context fullIPv6() throws RecognitionException {
		...
		enterRule(_localctx, 88, RULE_fullIPv6);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(525);
	...
	public final CompressedIPv6Context compressedIPv6() throws RecognitionException {
		...
		enterRule(_localctx, 90, RULE_compressedIPv6);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final HextetContext hextet() throws RecognitionException {
		...
		enterRule(_localctx, 92, RULE_hextet);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final HexaContext hexa() throws RecognitionException {
		...
		enterRule(_localctx, 94, RULE_hexa);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final SlashPathPartContext slashPathPart() throws RecognitionException {
		...
		enterRule(_localctx, 96, RULE_slashPathPart);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final PathSegmentContext pathSegment() throws RecognitionException {
		...
		enterRule(_localctx, 98, RULE_pathSegment);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(588);
					_la = _input.LA(1);
					if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 486543360L) != 0)) ) {
					_errHandler.recoverInline(this);
					}
					else {
						if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final AsteriskFormContext asteriskForm() throws RecognitionException {
		...
		enterRule(_localctx, 100, RULE_asteriskForm);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(594);
	...
	public final QueryPartContext queryPart() throws RecognitionException {
		...
		enterRule(_localctx, 102, RULE_queryPart);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(596);
	...
	public final QueryContentContext queryContent() throws RecognitionException {
		...
		enterRule(_localctx, 104, RULE_queryContent);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class QueryParamContext extends ParserRuleContext {
		public QueryKeyContext queryKey() {
			return getRuleContext(QueryKeyContext.class,0);
		}
		public TerminalNode EQUAL() { return getToken(HTTPParser.EQUAL, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HTTPParserListener ) ((HTTPParserListener)listener).enterQueryParam(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof HTTPParserListener ) ((HTTPParserListener)listener).exitQueryParam(this);
		}
	}
	...
	public final QueryParamContext queryParam() throws RecognitionException {
		...
		enterRule(_localctx, 106, RULE_queryParam);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(608);
	...
	@SuppressWarnings("CheckReturnValue")
	public static class QueryKeyContext extends ParserRuleContext {
		public List<TerminalNode> ALPHA_CHARS() { return getTokens(HTTPParser.ALPHA_CHARS); }
		public TerminalNode ALPHA_CHARS(int i) {
			return getToken(HTTPParser.ALPHA_CHARS, i);
		}
		...
		public QueryKeyContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_queryKey; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HTTPParserListener ) ((HTTPParserListener)listener).enterQueryKey(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof HTTPParserListener ) ((HTTPParserListener)listener).exitQueryKey(this);
		}
	}

	public final QueryKeyContext queryKey() throws RecognitionException {
		QueryKeyContext _localctx = new QueryKeyContext(_ctx, getState());
		enterRule(_localctx, 108, RULE_queryKey);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			...
			do {
				...
				case 1:
					...
					setState(613);
					_la = _input.LA(1);
					if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 487591936L) != 0)) ) {
					_errHandler.recoverInline(this);
					}
					else {
						if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public static class QueryValueContext extends ParserRuleContext {
		...
		public List<TerminalNode> EQUAL() { return getTokens(HTTPParser.EQUAL); }
		public TerminalNode EQUAL(int i) {
			return getToken(HTTPParser.EQUAL, i);
		}
		public List<TerminalNode> QUESTION_MARK() { return getTokens(HTTPParser.QUESTION_MARK); }
		public TerminalNode QUESTION_MARK(int i) {
			return getToken(HTTPParser.QUESTION_MARK, i);
		}
		public List<TerminalNode> HASH() { return getTokens(HTTPParser.HASH); }
		public TerminalNode HASH(int i) {
			return getToken(HTTPParser.HASH, i);
		}
		public List<TerminalNode> OPEN_BRAKET() { return getTokens(HTTPParser.OPEN_BRAKET); }
		public TerminalNode OPEN_BRAKET(int i) {
			return getToken(HTTPParser.OPEN_BRAKET, i);
		}
		public List<TerminalNode> CLOSE_BRAKET() { return getTokens(HTTPParser.CLOSE_BRAKET); }
		public TerminalNode CLOSE_BRAKET(int i) {
			return getToken(HTTPParser.CLOSE_BRAKET, i);
		}
		public List<TerminalNode> SCHEME_SEPARATOR() { return getTokens(HTTPParser.SCHEME_SEPARATOR); }
		public TerminalNode SCHEME_SEPARATOR(int i) {
			return getToken(HTTPParser.SCHEME_SEPARATOR, i);
		}
		public List<TerminalNode> SCHEME() { return getTokens(HTTPParser.SCHEME); }
		public TerminalNode SCHEME(int i) {
			return getToken(HTTPParser.SCHEME, i);
		}
		public List<TerminalNode> COMMA() { return getTokens(HTTPParser.COMMA); }
		public TerminalNode COMMA(int i) {
			return getToken(HTTPParser.COMMA, i);
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HTTPParserListener ) ((HTTPParserListener)listener).enterQueryValue(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof HTTPParserListener ) ((HTTPParserListener)listener).exitQueryValue(this);
		}
	}
	...
	public final QueryValueContext queryValue() throws RecognitionException {
		...
		enterRule(_localctx, 110, RULE_queryValue);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			...
			do {
				...
				case 1:
					...
					setState(618);
					_la = _input.LA(1);
					if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 1064695808L) != 0)) ) {
					_errHandler.recoverInline(this);
					}
					else {
						if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final FragmentPartContext fragmentPart() throws RecognitionException {
		...
		enterRule(_localctx, 112, RULE_fragmentPart);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(623);
	...
	public final FragmentContentContext fragmentContent() throws RecognitionException {
		...
		enterRule(_localctx, 114, RULE_fragmentContent);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			...
			do {
				...
				case 1:
					...
					setState(626);
					_la = _input.LA(1);
					if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 84957184L) != 0)) ) {
					_errHandler.recoverInline(this);
					}
					else {
						if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final HttpVersionContext httpVersion() throws RecognitionException {
		...
		enterRule(_localctx, 116, RULE_httpVersion);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(631);
	...
	public final VersionNumberContext versionNumber() throws RecognitionException {
		...
		enterRule(_localctx, 118, RULE_versionNumber);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(640);
	...
	public final InvalidContentContext invalidContent() throws RecognitionException {
		...
		enterRule(_localctx, 120, RULE_invalidContent);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			do {
				...
				setState(645);
				_la = _input.LA(1);
				if ( _la <= 0 || ((((_la) & ~0x3f) == 0 && ((1L << _la) & 712L) != 0)) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 140737488354614L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		switch (ruleIndex) {
		case 4:
			return headerLine_sempred((HeaderLineContext)_localctx, predIndex);
		case 6:
			return invalidHeaderLine_sempred((InvalidHeaderLineContext)_localctx, predIndex);
		}
		return true;
	}
	private boolean headerLine_sempred(HeaderLineContext _localctx, int predIndex) {
		switch (predIndex) {
		case 0:
			return _input.LA(1) == BODY_START_WITH_BLANK || _input.LA(1) == GENERIC_BODY_START || _input.LA(1) == BODY_START_NO_BLANK || _input.LA(1) == EOF;
		}
		return true;
	}
	private boolean invalidHeaderLine_sempred(InvalidHeaderLineContext _localctx, int predIndex) {
		switch (predIndex) {
		case 1:
			return _input.LA(2) != COLON && _input.LA(1) != COMMENT && _input.LA(1) != NEWLINE;
		}
		return true;
	}
	...
	public static final String _serializedATN =
		...
		"-\n-\f-\u0230\t-\u0003-\u0232\b-\u0001.\u0004.\u0235\b.\u000b.\f.\u0236"+
		"\u0001/\u0004/\u023a\b/\u000b/\f/\u023b\u00010\u00010\u00010\u00010\u0005"+
		"0\u0242\b0\n0\f0\u0245\t0\u00010\u00030\u0248\b0\u00030\u024a\b0\u0001"+
		"1\u00011\u00051\u024e\b1\n1\f1\u0251\t1\u00012\u00012\u00013\u00013\u0003"+
		"3\u0257\b3\u00014\u00014\u00014\u00054\u025c\b4\n4\f4\u025f\t4\u00015"+
		"\u00015\u00015\u00035\u0264\b5\u00016\u00046\u0267\b6\u000b6\f6\u0268"+
		"\u00017\u00047\u026c\b7\u000b7\f7\u026d\u00018\u00018\u00018\u00019\u0004"+
		"9\u0274\b9\u000b9\f9\u0275\u0001:\u0001:\u0001:\u0003:\u027b\b:\u0001"+
		":\u0001:\u0003:\u027f\b:\u0001;\u0001;\u0001;\u0003;\u0284\b;\u0001<\u0004"+
		"<\u0287\b<\u000b<\f<\u0288\u0001<\u0002\u00d6\u00f8\u0000=\u0000\u0002"+
		"\u0004\u0006\b\n\f\u000e\u0010\u0012\u0014\u0016\u0018\u001a\u001c\u001e"+
